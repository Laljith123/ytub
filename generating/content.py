...
def _build_prompt(trends: list[str], repeated: list[str]) -> str:
    ...
    return (
        ...
        "0a. The FIRST line must be 6-10 words and start with a shock opener "
        "(e.g., 'WAIT', 'STOP', 'HOLD UP', 'NO CAP', 'BRO', 'YO'). "
        ...
        "0c. Single idea only. No side plots, no extra cases. "
        "0d. Use compressed, punchy phrasing; remove fluff words. "
        ...
        f"4. Each script item = 1 short sentence (max 12 words), tight pacing ~{int(SCENE_SECONDS)}s per clip. "
        ...
        "14a. Add 1-2 hype words across the script (wild, insane, plot twist, "
        "sus, sketchy) to boost energy without disrespect. "
        "14d. Use 2-3 Gen Z words total across the script (no cap, lowkey, wild, "
        ...
        "15a. End with a direct CTA: 'Comment your answer' or 'Drop your answer'. "
        "15b. The last line must loop back to the first line by repeating the "
        "same opening 2-4 words to encourage rewatch. "
